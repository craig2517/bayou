...
export function ProfileForm({ profile, onSave, blockedUsers, onUnblockUser }: ProfileFormProps) {
  ...
  useEffect(() => {
    if (profile) {
      ...
      setReceiveMessagesFrom(profile.receiveMessagesFrom || ['Male', 'Female', 'Nonbinary'])
    ...
    <Card className="p-6 border-0 shadow-none">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-3 pt-2">
          <Label className="text-sm font-semibold">Be Seen, don't search - Select if your profile is visible, who can see it when visible, and who can connect:</Label>
